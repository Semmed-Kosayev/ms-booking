...
public class UserServiceAspect {
    ...
    @Around("execution(* az.edu.turing.booking.service.UserService.*(..))")
    ...
    @Before("execution(* az.edu.turing.booking.service.UserService.*(..))")
    public void logBeforeMethod(JoinPoint joinPoint) {
        log.info("Method called: {}", joinPoint.getSignature().getName());
    }

    @AfterReturning(value = "execution(* az.edu.turing.booking.service.UserService.*(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        log.info("Method successfully completed: {} | Result: {}", joinPoint.getSignature().getName(), result);
    }

    @AfterThrowing(value = "execution(* az.edu.turing.booking.service.UserService.*(..))", throwing = "ex")
